...
먼저 “비제한 와일드카드”라고 하는 `?`는 그야말로 “어떤 아이템이든 담긴 상자”라고 볼 수 있습니다.
...
다음으로 “상한 제한 와일드카드”인 `? extends Equipment`는 “장비류 아이템” 전용 상자를 열어보는 거랑 비슷하다고 볼 수 있습니다.

검이든 방어구든 뭐가 들어있는 "장비"라는 최상위 개념으로만 꺼낼 수 있습니다. 이 상한 제한 와일드카드도 비제한 와일드카드 처럼 다시 새로 장비를 넣을 순 없습니다.
